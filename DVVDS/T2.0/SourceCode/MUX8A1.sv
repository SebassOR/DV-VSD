module MUX8A1(
    input logic [3:0]I0, I1, I2, I3, I4, I5, I6, I7, //declaramos entradas de 1 bit
    input logic [2:0] S,                     //declaramos selecciones 
    output logic [3:0] Y                              //declaramos salidas
);

// Señales internas
logic [3:0] Y0, Y1, Y2, Y3, Y4, Y5;                   //conectores de salidas
